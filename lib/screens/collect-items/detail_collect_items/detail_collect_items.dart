...
class DetailCollectItems extends StatefulWidget {
  // Declare a field that holds the Todo.
  final dataDetail;
  // In the constructor, require
  DetailCollectItems({Key key, @required this.dataDetail}) : super(key: key);

  @override
  DetailCollectItemsState createState() => DetailCollectItemsState();
}

class DetailCollectItemsState extends State<DetailCollectItems> {
  ...
  String database='';
  Future panggilDetailCollectItems;
  dynamic hasil;
  dynamic res;
  ...
  void initState() {
    super.initState();
    // this.updateListView();
      panggilDetailCollectItems = fetchDetail();
  }
  ...
  Future fetchDetail() async {
    ...
    res =  await restDS.collectItemDetails(noBukti);
    setState(() {
  ...
  Future saveCollectItems() async {
    ...
    // database = sharedPreferences.getString("database");
      ...
      restDS.saveCollectItems(noBukti).then((res) {
          showCenterShortToast("Berhasil Collect item!");
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Detail Collect Items"),
