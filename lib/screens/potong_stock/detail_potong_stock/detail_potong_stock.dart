...
class DetailPotongStock extends StatefulWidget {
  // Declare a field that holds the Todo.
  final dataDetail;
  // In the constructor, require
  DetailPotongStock({Key key, @required this.dataDetail}) : super(key: key);

  @override
  DetailPotongStockState createState() => DetailPotongStockState();
}

class DetailPotongStockState extends State<DetailPotongStock> {
  ...
  String database='';
  Future panggilDetailPotongStock;
  dynamic hasil;
  dynamic res;
  ...
  void initState() {
    super.initState();
    // this.updateListView();
      panggilDetailPotongStock = fetchDetail();
  }
...
Future fetchDetail() async {
    ...
    res =  await restDS.fetchDetailPotongStock(noBukti);
    setState(() {
...
Future potongStock() async {
    restDS.potongStock(noBukti).then((res) {
        showCenterShortToast("Berhasil Potong Stock!");
          Navigator.pop(context);
    }).catchError((Object error) => 

      setState(() {
        showCenterShortToast("Gagal Potong Stock!");
        throw Exception('Failed to Potong Stock');
      })
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Detail Potong Stock"),
